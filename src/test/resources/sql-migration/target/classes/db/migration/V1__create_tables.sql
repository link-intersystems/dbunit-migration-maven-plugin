...
create table film (film_id smallint not null, title varchar(255) not null, description clob, release_year date, language_id uuid not null, original_language_id uuid, rental_duration smallint default 3 not null, rental_rate decimal(10,2) default 4.99 not null, length smallint, replacement_cost decimal(10,2) default 19.99 not null, rating varchar(255) default 'G', special_features varchar(255), last_update timestamp default CURRENT_TIMESTAMP not null, constraint pk_film primary key (film_id));
...
create table language (language_id uuid not null, name varchar(20) not null, last_update timestamp default CURRENT_TIMESTAMP not null, constraint pk_language primary key (language_id));
